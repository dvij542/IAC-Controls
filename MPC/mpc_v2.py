...
with rti.open_connector(
    ...
    print("Left lane :-")
    left_lane = np.array(left_lane).T/100.0
    right_lane = np.array(right_lane).T/100.0
    center_lane = np.array(center_lane).T/100.0
    print(left_lane)
    print("Right Lane :-")
    print(right_lane)
    print("Center Lane :-")
    ...
    plt.plot(left_lane[0],left_lane[1],'ro')
    plt.plot(right_lane[0],right_lane[1],'ro')
    np.savetxt('coordinates_c.txt', center_lane, delimiter=',')
    np.savetxt('coordinates_l.txt', left_lane, delimiter=',')
    np.savetxt('coordinates_r.txt', right_lane, delimiter=',')
    plt.show()
